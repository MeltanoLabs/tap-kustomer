...
# Streams to export
__all__ = ["UsersCurrentSettingsStream"]

    
class UsersCurrentSettingsStream(kustomerStream):
    """
    Get User Settings for Current User
    """

    name = "users_current_settings"
    path = "users/current/settings"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "users_current_settings.json"
