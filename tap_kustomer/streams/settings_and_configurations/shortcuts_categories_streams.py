...
# Streams to export
__all__ = ["ShortcutsCategoriesStream"]

    
class ShortcutsCategoriesStream(kustomerStream):
    """
    Get Shortcut Categories
    """

    name = "shortcuts_categories"
    path = "shortcuts/categories"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "shortcuts_categories.json"
