...
# Streams to export
__all__ = ["CustomersSearchesPositionsStream"]

    
class CustomersSearchesPositionsStream(kustomerStream):
    """
    Get Search Positions
    """

    name = "customers_searches_positions"
    path = "customers/searches/positions"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "customers_searches_positions.json"
