...
# Streams to export
__all__ = ["RoutingWorkSessionsCurrentStream"]

    
class RoutingWorkSessionsCurrentStream(kustomerStream):
    """
    Get Current Work Session
    """

    name = "routing_work_sessions_current"
    path = "routing/work-sessions/current"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "routing_work_sessions_current.json"
