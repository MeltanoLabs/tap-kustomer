...
# Streams to export
__all__ = ["RoutingWorkItemsStream"]

    
class RoutingWorkItemsStream(kustomerStream):
    """
    Get Work Items
    """

    name = "routing_work_items"
    path = "routing/work-items"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "routing_work_items.json"
