...
# Streams to export
__all__ = ["RoutingQueueRulesStream"]

    
class RoutingQueueRulesStream(kustomerStream):
    """
    Get Queue Rules
    """

    name = "routing_queue_rules"
    path = "routing/queue-rules"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "routing_queue_rules.json"
