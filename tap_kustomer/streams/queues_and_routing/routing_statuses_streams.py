...
# Streams to export
__all__ = ["RoutingStatusesStream"]

    
class RoutingStatusesStream(kustomerStream):
    """
    Get Routing User Statuses
    """

    name = "routing_statuses"
    path = "routing/statuses"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "routing_statuses.json"
