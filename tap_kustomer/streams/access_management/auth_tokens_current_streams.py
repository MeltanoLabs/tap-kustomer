...
# Streams to export
__all__ = ["AuthTokensCurrentStream"]

    
class AuthTokensCurrentStream(kustomerStream):
    """
    Get Current Auth Token
    """

    name = "auth_tokens_current"
    path = "auth/tokens/current"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "auth_tokens_current.json"
