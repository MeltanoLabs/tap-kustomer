...
# Streams to export
__all__ = ["AuthCustomerSettingsStream"]

    
class AuthCustomerSettingsStream(kustomerStream):
    """
    Get Auth Customer Settings
    """

    name = "auth_customer_settings"
    path = "auth/customer/settings"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "auth_customer_settings.json"
