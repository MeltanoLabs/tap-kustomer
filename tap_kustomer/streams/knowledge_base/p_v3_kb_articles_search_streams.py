...
# Streams to export
__all__ = ["PV3KbArticlesSearchStream"]

    
class PV3KbArticlesSearchStream(kustomerStream):
    """
    Search Articles (Public)
    """

    name = "p_v3_kb_articles_search"
    path = "p/v3/kb/articles/search"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "p_v3_kb_articles_search.json"
