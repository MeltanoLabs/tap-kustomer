...
# Streams to export
__all__ = ["V3KbTemplatesStream"]

    
class V3KbTemplatesStream(kustomerStream):
    """
    Get Templates
    """

    name = "v3_kb_templates"
    path = "v3/kb/templates"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "v3_kb_templates.json"
