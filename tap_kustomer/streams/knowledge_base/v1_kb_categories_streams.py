...
# Streams to export
__all__ = ["V1KbCategoriesStream"]

    
class V1KbCategoriesStream(kustomerStream):
    """
    Get Categories
    """

    name = "v1_kb_categories"
    path = "v1/kb/categories"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "v1_kb_categories.json"
