...
# Streams to export
__all__ = ["PV3KbArticlesStream"]

    
class PV3KbArticlesStream(kustomerStream):
    """
    Get Articles (Public)
    """

    name = "p_v3_kb_articles"
    path = "p/v3/kb/articles"
    primary_keys = ["id"]
    replication_key = "updatedAt"
    schema_filepath = SCHEMAS_DIR / "p_v3_kb_articles.json"
